...
const AdminAddProduct = () => {
  ...
  return (
    <div className="container my-5 p-4 rounded shadow" style={{ maxWidth: "700px", backgroundColor: "#f9f9f9" }}>
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <div className="mb-3">
          ...
          <button type="button" className="btn btn-primary" onClick={addSpecField}>Thêm thông số kỹ thuật</button>
        </div>

        <div className="d-grid">
          <button type="submit" className="btn btn-dark" disabled={productLoading || specLoading}>
            {(productLoading || specLoading) ? "Đang thêm..." : "Thêm sản phẩm"}
          </button>
        </div>
      </form>
    </div>
