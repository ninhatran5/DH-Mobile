                  ...
                  if (!attributeId) {
                    attributeId = Object.keys(attributeValues).find((id) => {
                      ...
                      return (
                        ...
                        arr.length > 0 &&
                        arr[0].attribute &&
                        arr[0].attribute.name.toLowerCase() ===
...
const AdminProductEdit = () => {
      ...
      try {
        ...
        if (error.message) {
          if (error.message.includes("foreign key constraint")) {
            errorMessage =
              "Không thể xóa biến thể do còn liên kết với dữ liệu khác";
  ...
  return (
    <div
      className="admineditproduct-container"
      style={{
        padding: "5px 10px",
        maxWidth: "1200px",
        margin: "0 auto",
    ...
    >
      <div
        className="admineditproduct-header"
        style={{
          marginBottom: "0px",
          display: "flex",
      ...
      >
        <h1 className="admineditproduct-title" style={{ margin: 0 }}>
          Chỉnh sửa sản phẩm
        </h1>
              ...
              <div className="card shadow-sm h-100">
                ...
                >
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    <h4 className="card-title mb-0" style={{ fontSize: 17 }}>
                      Thông số kỹ thuật
                    </h4>
                    <button
                      type="button"
                  ...
                  {showAddSpecForm && (
                    <div className="add-spec-form mb-3 p-3 border rounded bg-light">
                      <h5 className="mb-2" style={{ fontSize: 14 }}>
                        Thêm thông số mới
                      </h5>
                  ...
                  <div className="specifications-container">
                        ...
                        <div className="row g-2 w-100">
                          ...
                          <div className="col-md-2 d-flex align-items-end justify-content-end">
                            <button
                              ...
                              onClick={() =>
                                handleDeleteSpecification(spec.spec_id)
                              }
                    ...
                    {specificationsData.length > 0 && (
                      <div className="mt-3">
                        ...
                        >
                          <i className="bi bi-save"></i> Cập nhật tất cả thông
                          số kỹ thuật
                        </button>
                      </div>
                    )}
                    {specificationsData.length === 0 && (
                      ...
                      >
                        ...
                        ></i>
                        <p className="mt-2">
                          Chưa có thông số kỹ thuật nào. Hãy thêm thông số mới!
                        </p>
                      </div>
                    )}
                  </div>
                      ...
                      .map((variant) => (
                        ...
                        >
                          <VariantDisplay
                            variant={variant}
                            onEdit={(v) =>
                              navigate(`/admin/variants/update/${v.variant_id}`)
                            }
